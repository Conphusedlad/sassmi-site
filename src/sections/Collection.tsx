...
export function Collection() {
  ...
  return (
    <section id="collection" className="scroll-mt-20 bg-ivory py-24 sm:py-32">
      <Container>
        <SectionHead kicker="The collection" title={<>Thirteen flavours.<br />One midnight tin.</>} sub="Every tin starts with the same plump, evenly-popped makhana from Mithila. Then each one goes somewhere different — savoury, spicy, sweet, and one ready-to-serve kheer." />
